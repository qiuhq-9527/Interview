...
type CalculatorServiceClient interface {
	...
	Calculate(context.Context, *connect.Request[calculatorv1.CalculateRequest]) (*connect.Response[calculatorv1.CalculateResponse], error)
}
...
func NewCalculatorServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CalculatorServiceClient {
	...
	calculatorServiceMethods := calculatorv1.File_proto_calculator_v1_calculator_proto.Services().ByName("CalculatorService").Methods()
	return &calculatorServiceClient{
		calculate: connect.NewClient[calculatorv1.CalculateRequest, calculatorv1.CalculateResponse](
			httpClient,
...
type calculatorServiceClient struct {
	calculate *connect.Client[calculatorv1.CalculateRequest, calculatorv1.CalculateResponse]
}

// Calculate calls calculator.v1.CalculatorService.Calculate.
func (c *calculatorServiceClient) Calculate(ctx context.Context, req *connect.Request[calculatorv1.CalculateRequest]) (*connect.Response[calculatorv1.CalculateResponse], error) {
...
func (UnimplementedCalculatorServiceHandler) Calculate(context.Context, *connect.Request[calculatorv1.CalculateRequest]) (*connect.Response[calculatorv1.CalculateResponse], error) {
